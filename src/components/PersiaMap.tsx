...
/* Irã */
const IRAN_OUTLINE =
  "M280 120 L400 80 L560 90 L680 120 L760 160 L780 220 L760 290 L700 340 L620 380 L520 400 L420 400 L330 360 L280 300 L260 200 Z";

/* Afeganistão */
const AFGHAN_OUTLINE = "M760 160 L840 140 L900 170 L920 230 L880 290 L820 300 L770 260 L780 220 Z";

/* Ásia Central (Uzbequistão / Tajiquistão) */
const CENTRAL_ASIA_OUTLINE = "M680 120 L700 70 L820 50 L950 80 L970 140 L900 180 L840 150 L780 170 L760 160 Z";
...
export function PersiaMap({
  ...
  return (
    <section className="flex flex-col gap-3">
      <div className="fade-up flex flex-wrap items-end justify-between gap-3 px-1">
        <div>
          <p className="font-mono text-[10px] font-semibold tracking-[0.22em] text-ink-soft uppercase">
            مسیر فارسی · 12 paradas + exame · Irã, Afeganistão, Tajiquistão e Uzbequistão
          </p>
          <h1 className="mt-1 max-w-xl font-display text-2xl leading-[1.08] font-extrabold tracking-tight sm:text-[28px]">
            De Teerã a Samarcanda, <span className="text-bus">uma semana de cada vez</span>
          </h1>
        </div>
        <button
          onClick={onGoPlan}
      ...
      <div className="fade-up paper-grid relative overflow-hidden rounded-xl border-2 border-ink/25 bg-[#e3ddca] shadow-print" style={{ animationDelay: "120ms" }}>
        ...
        <div className="flex w-full justify-center sm:py-2">
          <div className="relative aspect-[1000/640] h-auto max-h-[78vh] w-full sm:w-auto sm:max-w-full sm:flex-1" style={{ maxHeight: "min(78vh, 760px)" }}>
            <svg viewBox={`0 0 ${VB_W} ${VB_H}`} className="absolute inset-0 h-full w-full" role="img" aria-label="Mapa do Irã, Afeganistão, Tajiquistão e Uzbequistão com as 13 paradas da rota de farsi">
              {/* ondas decorativas (mares) */}
              <g stroke="#a8c8d8" strokeWidth="1.6" fill="none" strokeLinecap="round" opacity="0.9">
                <path d="M60 80 q6-8 12 0 t12 0" />
                <path d="M120 560 q6-8 12 0 t12 0" />
                <path d="M900 520 q6-8 12 0 t12 0" />
                <path d="M950 320 q6-8 12 0 t12 0" />
              </g>

              {/* territórios */}
              <path d={IRAN_OUTLINE} fill="#efe7d3" stroke="rgba(30,42,56,0.55)" strokeWidth="2" strokeLinejoin="round" />
              <path d={AFGHAN_OUTLINE} fill="#efe7d3" stroke="rgba(30,42,56,0.55)" strokeWidth="2" strokeLinejoin="round" />
              <path d={CENTRAL_ASIA_OUTLINE} fill="#efe7d3" stroke="rgba(30,42,56,0.55)" strokeWidth="2" strokeLinejoin="round" />

              {/* mar Cáspio */}
              <ellipse cx="330" cy="170" rx="38" ry="58" fill="#a6d3e6" stroke="#8fc6de" strokeWidth="1.5" />

              {/* deserto (pontilhado) */}
              <g fill="rgba(190,150,80,0.35)">
                <circle cx="490" cy="330" r="2" />
                <circle cx="510" cy="345" r="2" />
                <circle cx="530" cy="325" r="2" />
                <circle cx="555" cy="340" r="2" />
                <circle cx="470" cy="350" r="2" />
                <circle cx="540" cy="355" r="2" />
              </g>

              {/* montanhas (Alborz / Zagros / Pamir) */}
              <g fill="none" stroke="rgba(30,42,56,0.28)" strokeWidth="1.4" strokeLinecap="round">
                <path d="m380 200 8-13 8 13M396 214 404 201l8 13" />
                <path d="m580 260 7-11 7 11" />
                <path d="m870 200 8-13 8 13" />
              </g>
              ...
              <g fontFamily="'IBM Plex Mono', monospace" fontSize="8.5" letterSpacing="1.8" fill="rgba(30,42,56,0.32)" fontWeight={600} textAnchor="middle">
                <text x="330" y="90">MAR CÁSPIO</text>
                <text x="200" y="300">عراق</text>
                <text x="500" y="450" fontSize="10">خليج فارس · GOLFO PÉRSICO</text>
                <text x="870" y="330">افغانستان</text>
                <text x="860" y="110" fontSize="9">تاجیکستان · ازبکستان</text>
                <text x="470" y="140" fontSize="10">البرز</text>
                <text x="560" y="310" fontSize="9">کویر لوت</text>
                <text x="820" y="150" fontSize="8">پامیر</text>
              </g>
